...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Adjust to the origin of your client application
...
class DetectionResult(BaseModel):
    detection_model_name: str  # Renamed from model_name
    percentage: str
...
# Note: The function definitions continue beyond this point. Ensure that you follow the pattern of renaming 'model_name' 
# to 'detection_model_name' in the rest of your code as well.
